ace.define(
  'ace/mode/grammar_highlight_rules',
...
ace.define(
  ...
  function (require, exports, module) {
    ...
    var HighlightRules =
      require('./grammar_highlight_rules').GrammarHighlightRules
...
;(function () {
  ace.require(['ace/mode/grammar'], function (m) {
